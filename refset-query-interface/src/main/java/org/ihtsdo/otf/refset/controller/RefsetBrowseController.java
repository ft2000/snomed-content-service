...
public class RefsetBrowseController {
    ...
    public ResponseEntity<Response< Map<String, Object>>> getRefsets( @RequestParam( value = "page", defaultValue = "1" ) int page, 
    	...
    	try {
			...
			List<Refset> refSets =  bService.getRefsets( page, size );
    ...
    public ResponseEntity<Response< Map<String, Object>>> getRefsetDetails( @PathVariable( value = "refSetId" ) String refSetId ) {
